    ...
    <>
      <div className='header'>
        <div className='header-left'>
          ...
          <NavLink exact className='header-link' activeClassName='' to=''>{translate('header.menu')}</NavLink>
          <NavLink exact className='header-link' activeClassName='' to=''>{translate('header.popular')}</NavLink>
        </div>
        <div className='header-center'>
          <img className='headerimage' src={ HeaderLogo } alt='Header'/>
        </div>
        <div className='header-right'>
          <NavLink exact className='header-link' activeClassName='header-link__active' to='/sign-up'>{translate('header.signup')}</NavLink>
          {logButton}
